    ...
    describe('Dto is not corrected data', () => {
      ...
      test('name - incorrect', async () => {
        ...
        const data = {
          ...
          errorList: {
            isEnum:
              'The name is incorrect and should have: Telegram,GitHab,GitLab,Linkedin,Skype,Instagram,Facebook,Viber,Signal,WhatsApp,twitter,apple',
      ...
      test('link - incorrect', async () => {
        ...
        const data = {
          ...
          property: 'link',
          errorList: {
            isString: 'The link is incorrect',
            isNotEmpty: 'The link necessarily is required',
          },
        };
        expect(e.value).toEqual(data.value);
        expect(e.property).toEqual(data.property);
    ...
    test('error', async () => {
      const data = {
        ...
        payload: {
          ...
          message: 'This Sociol link exists',
        },
      };
    ...
    test('default data - error', async () => {
      const data = {
        ...
        payload: {
          status: 404,
          defaultMessage: 'Not Found',
          message: 'This Sociol link not update',
        },
      };
